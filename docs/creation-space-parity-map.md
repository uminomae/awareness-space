...
| topics workflow | `transform/topics/`, `transform/scripts/build-pdf-guide.sh`, `transform/scripts/publish-awareness-topics.sh` | `transform/topics/`, `transform/scripts/build-pdf-guide.sh` | 概ね整備済み | 追加実装時は `transform/topics/WORKFLOW.md` との差分検査を先に行う。2026-03-24 に `transform/topics/README.md` へ既存公開物の配置先を明記済み。`WORKFLOW.md` も Git 規約と publish 対象に合わせて更新済み |
