...
- 主題: 調査トピックごとの公開ドラフト
- 中心: 生存-信頼軸、4層モデル、Concept Notes など個別論点
...
- 神経現象学と心理学が中核参照領域である
- 過去の source 束は歴史的素材であり、現在の正本ではない
- 抱持は意識モデルの構成要素として採用せず、調査観測待ちの候補語としてのみ扱う
...
- 公開済み report は調査トピックごとの公開ドラフトである
- 神経現象学と心理学の接続設計は進行中である
- 生存-信頼軸、観測可能性はまだ未解決が多い
- 抱持は現行モデルの論点としては採用していない
