# 変換ルール: 調査トピックレポート v0.5

**対象コンテンツ**: `生存-信頼軸`, `4層モデル`  
...
`awareness-space` の `domains` は「統合的な全体調査報告を組むための調査トピック束」を legacy 名で扱う。
...
- 生HTMLのアンカータグは公開 Markdown に書かない。
