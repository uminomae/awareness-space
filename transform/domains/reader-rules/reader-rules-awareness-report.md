...
**対象コンテンツ**: `FO軸`, `4層モデル`, `M1意識OS`, `concept notes` 等  
...
- 「です・ます調」を推奨
- 解決しない問いは、暫定結論として明示
- F-O軸は採択済みではなく検証仮説として扱う
- `Withhold` は中心主題として固定せず、必要な場合だけ限定的に扱う
