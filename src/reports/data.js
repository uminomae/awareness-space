...
export const DEFAULT_PROGRESS_TAXONOMY = [
    ...
    },
    {
        id: 'report_ready',
        labelJa: '公開ドラフト',
        labelEn: 'Draft available',
        descriptionJa: '読者向け draft を modal で読める。理論統合の完了は未保証',
        descriptionEn: 'A reader-facing draft is available in modal view. Integrated synthesis is not yet guaranteed',
        tone: 'success',
        order: 30,
    },
];
