...
export const DEFAULT_PROGRESS_TAXONOMY = [
    ...
    },
    {
        ...
        labelJa: '公開中',
        labelEn: 'Published',
        descriptionJa: '読者向け report と PDF を参照できる。理論統合の完了は未保証',
        descriptionEn: 'A reader-facing report and PDF are available. Integrated synthesis is not yet guaranteed',
        tone: 'success',
        order: 30,
    },
];
